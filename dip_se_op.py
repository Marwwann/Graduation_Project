...
def dip_se_op(model_path, netlist_path, vdd_net, gnd_net, vinn, vinp, vout, VDD_in, VINCM_in, cap_in, start_freq_in, stop_freq_in, no_points_in):
    ...
    C1 {vout} {gnd_net} {cap}
    X1 {vinn} {vinp} {vdd_net} {gnd_net} {vout} fivetota
...
'''
x = dip_se_op('D:\\Grad_Project\\Github\\task5\\130nm_bulk.LIB', 'C:\\Users\\Marawan\\Desktop\\subcircuit.txt', '3', '0',
              '1', '2', '5', '1.2', '730m', '1p', '1', '10G', '10')
